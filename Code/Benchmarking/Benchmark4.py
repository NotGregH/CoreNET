...
def run_benchmarks():
	...
	for i in filesList:
		...
		subprocess.call(["C:\WINDOWS\system32\WindowsPowerShell\\v1.0\powershell.exe", "python -m memory_profiler Network_Query.py -d Benchmark.db -o Test.SIF " + 
			"-g .\Test_Lists\\" + i + " | Out-File -Append  Run1_0Hop_noFilter.txt"], shell=True)

		subprocess.call(["C:\WINDOWS\system32\WindowsPowerShell\\v1.0\powershell.exe","python -m memory_profiler Network_Query.py -d Benchmark.db -o Test.SIF " + 
			"-j 1 -g .\Test_Lists\\" + i + " | Out-File -Append  Run1_1Hop_noFilter.txt"], shell = True)


		subprocess.call(["C:\WINDOWS\system32\WindowsPowerShell\\v1.0\powershell.exe","python -m memory_profiler Network_Query.py -d Benchmark.db -o Test.SIF " + 
			"-e .\Edge_lists\ppEdges.txt -g .\Test_Lists\\" + i + " | Out-File -Append  Run1_0Hop_Filter.txt"], shell=True)

		subprocess.call(["C:\WINDOWS\system32\WindowsPowerShell\\v1.0\powershell.exe","python -m memory_profiler Network_Query.py -d Benchmark.db -o Test.SIF " + 
			"-e .\Edge_lists\ppEdges.txt -j 1 -g .\Test_Lists\\" + i + " | Out-File -Append  Run1_1Hop_Filter.txt"], shell = True)
